...
@app.route("/")
def hello():
    return render_template('index.html', title=_title, cellSize=_cellSize, width=_width, height=_height, channels=",".join([channel for channel in _channels]), red=_red, green=_green, blue=_blue)
